...
![image.png](https://storage.deepin.org/thread/20220925175816540_image.png)

![tail](https://bbs.deepin.org/assets/image/raccoon/[tail].gif "tail")
...
Gitlink：[https://www.gitlink.org.cn/gfdgd\_xi/deep-wine-runner](https://www.gitlink.org.cn/gfdgd_xi/deep-wine-runner)  
...
程序官网：[https://gfdgd-xi.github.io/](https://gfdgd-xi.github.io/)  
支持程序自带的更新程序进行更新  
...
**现在新增了通过SHA1值获取应用适配情况的功能，查看链接：[https://gfdgd-xi.github.io/wine-runner-info/](https://gfdgd-xi.github.io/wine-runner-info/)，如何贡献自己的适配情况？在 Wine 运行器进行评分即可**  
**自动配置文件的脚本如何编写/贡献？可见：[https://gitlink.org.cn/gfdgd\_xi/wine-runner-list/tree/master/auto](https://gitlink.org.cn/gfdgd_xi/wine-runner-list/tree/master/auto) 如果想要贡献请按照下面的要求进行Pr**
